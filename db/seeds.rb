...
horsepower_to_mulepower = Conversion.find_or_create_by(name: "Base Mule-Power", user_id: 1, hp_quantity: 1, animal_type: "Mule", animal_conversion_quantity: 2.31481481)
...
horsepower_to_manpower = Conversion.find_or_create_by(name: "Base Man-Power", user_id: 1, hp_quantity: 1, animal_type: "Man", animal_conversion_quantity: 11.1111111)
...
horsepower_to_lionpower = Conversion.find_or_create_by(name: "Base Lion-Power", user_id: 1, hp_quantity: 1, animal_type: "Lion", animal_conversion_quantity: 0.66357)
