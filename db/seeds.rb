...
horsepower_to_oxpower = Conversion.find_or_create_by(name: "Base Ox-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 1.73611111)
MeasurementConversion.find_or_create_by(name: "Horse-Power to Ox-Power", conversion_id: 1, measurement_id: 2)
horsepower_to_mulepower = Conversion.find_or_create_by(name: "Base Mule-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 2.31481481)
MeasurementConversion.find_or_create_by(name: "Horse-Power to Mule-Power", conversion_id: 2, measurement_id: 3)
horsepower_to_donkeypower = Conversion.find_or_create_by(name: "Base Donkey-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 4.62962963)
MeasurementConversion.find_or_create_by(name: "Horse-Power to Donkey-Power", conversion_id: 3, measurement_id: 4)
horsepower_to_manpower = Conversion.find_or_create_by(name: "Base Man-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 11.1111111)
MeasurementConversion.find_or_create_by(name: "Horse-Power to Man-Power", conversion_id: 4, measurement_id: 5)
horsepower_to_squirrelpower = Conversion.find_or_create_by(name: "Base Squirrel-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 1334.6775)
MeasurementConversion.find_or_create_by(name: "Horse-Power to Squirrel-Power", conversion_id: 5, measurement_id: 6)
horsepower_to_duckpower = Conversion.find_or_create_by(name: "Base Duck-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 300)
MeasurementConversion.find_or_create_by(name: "Horse-Power to Duck-Power", conversion_id: 6, measurement_id: 7)
horsepower_to_lionpower = Conversion.find_or_create_by(name: "Base Lion-Power", user_id: 1, measure_1_quantity: 1, measure_2_quantity: 0.66357)
