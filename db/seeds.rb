...
horsepower = Measurement.find_or_create_by(name: "Horse-Power (mechanical)", animal_power_to_hp: 1, standard: true)
#Strange Measurements
oxpower = Measurement.find_or_create_by(name: "Ox-Power", animal_power_to_hp: 0.576, source: "https://www.sjsu.edu/faculty/watkins/animalpower.htm", standard: false)
mulepower = Measurement.find_or_create_by(name: "Mule-Power", animal_power_to_hp: 0.432, source: "https://www.sjsu.edu/faculty/watkins/animalpower.htm", standard: false)
donkeypower = Measurement.find_or_create_by(name: "Donkey-Power", animal_power_to_hp: 0.216, source: "https://www.sjsu.edu/faculty/watkins/animalpower.htm", standard: false)
manpower = Measurement.find_or_create_by(name: "Man-Power", animal_power_to_hp: 0.090, source: "https://www.sjsu.edu/faculty/watkins/animalpower.htm", standard: false)
squirrelpower = Measurement.find_or_create_by(name: "Squirrel-Power", animal_power_to_hp: 0.0007492446677193555, source: "https://eagletalon.net/squirrelpower/", standard: false)
duckpower = Measurement.find_or_create_by(name: "Duck-Power", animal_power_to_hp: 0.00333333, source: "https://www.reddit.com/r/theydidthemath/comments/4oyzjm/converting_horsepower_to_duckpower/", standard: false)
lionpower = Measurement.find_or_create_by(name: "Lion-Power", animal_power_to_hp: 1.507, source: "https://www.reddit.com/r/theydidthemath/comments/5xkxf0/request_how_much_horsepower_can_a_lion_generate/", standard: false)
#conversions
